    ...
    <div class="col bg-white p-3">
        ...
        <div class="row">
            <div class="col button-group overflow-auto">
                ...
                <a class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.terno.dezena') }}"><b>Terno de
                        Dezena</b></a>
                <a class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.terno.grupo') }}"><b>Terno de
                        Grupo</b></a>
                <a class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.duque.dezena') }}"><b>Duque de
                        Dezena</b></a>
                <a class="btn btn-outline-primary mt-1" href="{{ route('admin.bets.bichao.duque.grupo') }}"><b>Duque de
                        Grupo</b></a>
            </div>
        </div>
        <hr/>
        ...
        <div id="animals-group" class="container">
            <hr />
            <div class="row">
                <div class="col">
                    <p>Escolha o grupo</p>
            ...
            <div class="row">
                <div class="col">
                    <div id="animal-container" button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-1" onclick="select_animals_1()" class="btn btn-outline-primary">
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-2" onclick="select_animals_2()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        02
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-3" onclick="select_animals_3()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        03
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-4" onclick="select_animals_4()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        04
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-5" onclick="select_animals_5()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        05
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-6" onclick="select_animals_6()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        06
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-7" onclick="select_animals_7()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        07
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-8" onclick="select_animals_8()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        08
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-9" onclick="select_animals_9()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        09
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-10" onclick="select_animals_10()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        10
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-11" onclick="select_animals_11()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        11
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-12" onclick="select_animals_12()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        12
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-13" onclick="select_animals_13()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        13
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-14" onclick="select_animals_14()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        14
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-15" onclick="select_animals_15()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        15
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-16" onclick="select_animals_16()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        16
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-17" onclick="select_animals_17()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        17
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-18" onclick="select_animals_18()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        18
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-19" onclick="select_animals_19()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        19
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-20" onclick="select_animals_20()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        20
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-21" onclick="select_animals_21()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        21
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-22" onclick="select_animals_22()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        22
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-23" onclick="select_animals_23()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        23
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-24" onclick="select_animals_24()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        24
                    ...
                    <div button-variant="outline-primary" class="wrap-animal btn-group-toggle d-inline-block mb-1">
                        <label id="animal-container-25" onclick="select_animals_25()" class="btn btn-outline-primary">
                            <div class="animal container">
                                <div class="row">
                                    <div class="col-2 ">
                                        25
