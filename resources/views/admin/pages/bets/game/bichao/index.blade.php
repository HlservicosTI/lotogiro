...
@section('content')
    <div class="col bg-white p-3">
            ...
            <div style="background-color:#E9ECEF;" class="col-4 h-auto">
                ...
                <div class="row">
                    <div class="col text-center align-items-end mb-4">
                        <button class="btn btn-success" type="submit">Carregar Jogo</button>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="row">
            <div class="col button-group overflow-auto">
                ...
                <a type="button" class="btn btn-outline-primary"
                    href="{{ route('admin.bets.bichao.duque.dezena') }}"><b>Duque de Dezena</b></>
                    <a type="button" class="btn btn-outline-primary mt-1"
        ...
        <div class="form-row">
            ...
            <div class="container" id="milhar-group">
                <hr />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col button-group">
                        ...
                        <a><button id="btn-validate" onclick="check_award()" class="btn btn-success"><b>Validar
                                    Seleção</b></button></a>
                    </div>
                </div>
                <div class="row mt-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="col mb-2">
                        <a href="{{ route('admin.bets.bichao.add.chart')}}" id="btn-add-to-chart" class="btn btn-success disabled">
    ...
    @push('scripts')
        <script src=" {{ asset('admin/layouts/plugins/bs-custom-file-input/bs-custom-file-input.js') }}"></script>
        <script src=" {{ asset('admin/layouts/plugins/jquery/jquery.min.js') }}"></script>
        <script src=" {{ asset('admin/layouts/plugins/overlayScrollbars/js/jquery.overlayScrollbars.js') }}"></script>
        <script src=" {{ asset('admin/layouts/plugins/toastr/toastr.min.js') }}"></script>
        <script src=" {{ asset('admin/layouts/plugins/datatables-bs4/js/dataTables.bootstrap4.js') }}"></script>
        ...
        <script>
            ...
            function insere_valor() {
                ...
                input_milhar.val((randomNumber(0, 9) + '' + randomNumber(0, 9) + '' + randomNumber(0, 9) + '' + randomNumber(0,
                    9)));
            }
