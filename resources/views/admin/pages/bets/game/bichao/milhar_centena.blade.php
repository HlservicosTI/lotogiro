    ...
    <div class="col bg-white p-3">
        ...
        <div class="row">
            <div class="col button-group overflow-auto">
                ...
                <a type="button" class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.duque.dezena')}}"><b>Duque de Dezena</b></>
                <a type="button" class="btn btn-outline-primary mt-1" href="{{ route('admin.bets.bichao.duque.grupo')}}"><b>Duque de Grupo</b></a>
            </div>
        </div>
        <hr/>
        <div class="form-row">
