...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#btn_delete_role', function () {
            ...
            var url = '<?php echo e(route("admin.settings.roles.destroy", ":role")); ?>';
        ...
        $(document).ready(function () {
            var table = $('#role_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('admin.settings.roles.index')); ?>",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/lotogiro-login/lotogiro/resources/views/admin/pages/settings/role/index.blade.php ENDPATH**/ ?>